- لما باخد شيل علي جهاز بيكون الشيل ده الاوامر اللي فيه محدوده فا احنا بنحتاج نفتح interactive shell او TTY shell وده عرفناه قبل كده بالpython طب لو مفيش python علي جهاز الvictim؟
- اول ماتشوف الاوامر دي اعرف اني في شل النظام بيستخدمها عشان ينفذ اوامر والنقطة المهمة:  
**مش لازم تكون Bash أو Sh بس.**  
ممكن تتغير لأي shell interpreter موجود على النظام
...
- الامر بتاع `sudo -l` ده بيجبلك الاوامر اللي تقدر تنفذها علي الجهاز ده كا root من غير authentication
----
