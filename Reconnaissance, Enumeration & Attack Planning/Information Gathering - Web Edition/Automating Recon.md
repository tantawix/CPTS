...
```shell-session
0xTroj6n@htb[/htb]$ git clone https://github.com/thewhiteh4t/FinalRecon.git
0xTroj6n@htb[/htb]$ cd FinalRecon
0xTroj6n@htb[/htb]$ pip3 install -r requirements.txt
0xTroj6n@htb[/htb]$ chmod +x ./finalrecon.py
0xTroj6n@htb[/htb]$ ./finalrecon.py --help
...
```shell-session
0xTroj6n@htb[/htb]$ ./finalrecon.py --headers --whois --url http://inlanefreight.com
